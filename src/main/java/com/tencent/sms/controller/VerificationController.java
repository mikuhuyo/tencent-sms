...
public class VerificationController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "effectiveTime", value = "验证信息有效期(秒)", required = true, dataType = "String", paramType = "query")
    })
